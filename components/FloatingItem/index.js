...
const FloatingItem = props => {
    ...
    return(
        <button className="relative rounded-full w-12 h-12 overflow-hidden transition-all duration-300 hover:w-32 hover:shadow-lg bg-gray-700 text-white  flex justify-center items-center mb-1">
            {iconFunction(20)}
